...
Public Class Prcatica_Catalogo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SAMAD.Prcatica_Catalogo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPrcatica_Catalogo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Prcatica_Catalogo = New Prcatica_Catalogo()
        rpt.Site = Me.Site
        Return rpt
    End Function

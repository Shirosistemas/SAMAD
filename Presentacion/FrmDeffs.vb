Public Class FrmDeffs
    Private dt As New DataTable
    Dim func As New fdeffs 'Creacion una variable para hacer referencia a la funcion fconcesiones
    ...
    Private Sub formatear_grid()
        ...
        dataListado.Columns(2).HeaderText = "Sede"
    ...
    Private Sub buscar()
        Try
            ...
            dv.RowFilter = String.Format("def_sede Like '%{0}%'", txtBuscar.Text) 'Filtramos la busqueda
            If dv.Count <> 0 Then
                lblinexistente.Visible = False
    ...
    End Sub
    Private Sub FrmDeffs_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        deshabilitar()
        mostrar()
        formatear_grid()
        dataListado.Focus()
    ...
    Private Sub btnGuardar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGuardar.Click
        ...
        validar_campos()
        If nuevo = True Then
            If New fdeffs().DeffExiste(txtDescripcion.Text) = True Then
                MessageBox.Show("El Nombre del registro ya existe", xTitulo, MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
                txtDescripcion.Focus()
                Exit Sub
            End If
        End If
        If sw_guardar = True Then 'Guardamos si los controles no estan vacios
            ...
            If result = DialogResult.OK Then
                Try
                    Dim dts As New vDeffs
                    Dim func As New fdeffs

                    dts.gsede = txtDescripcion.Text
    ...
    End Sub
    Private Sub chkEliminar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles chkEliminar.Click
            ...
            Try
                For Each row As DataGridViewRow In dataListado.Rows
                    ...
                    If marcado Then
                        ...
                        Dim onekey As Integer = Convert.ToInt32(row.Cells("def_id").Value)
                        Dim vdb As New vDeffs
                        Dim func As New fdeffs

...
Public Class CatalogoReporte_01
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SAMAD.CatalogoReporte_01.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCatalogoReporte_01
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CatalogoReporte_01 = New CatalogoReporte_01()
        rpt.Site = Me.Site
        Return rpt
    End Function

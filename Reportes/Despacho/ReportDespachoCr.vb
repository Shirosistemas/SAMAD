...
Public Class ReportDespachoCr
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SAMAD.ReportDespachoCr.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReportDespachoCr
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReportDespachoCr = New ReportDespachoCr()
        rpt.Site = Me.Site
        Return rpt
    End Function
